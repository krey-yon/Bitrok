...
const measures = ["Encrypted public connections", "Passwords hashed with bcrypt", "GitHub OAuth sign-in", "Dependency monitoring", "Content Security Policy headers", "API rate limiting"];

export default function SecurityPage() {
  const email = process.env.SECURITY_CONTACT_EMAIL || "security@example.com";
